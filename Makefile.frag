...
install-cuda:
	...
	$(NVCC)  -I. -I $(COMMON_FLAGS) $(CFLAGS_CLEAN) $(EXTRA_CFLAGS)  $(ALL_CCFLAGS) $(GENCODE_FLAGS)  -c $(builddir)./src/ndarray_ops.c -shared -Xcompiler -fPIC -o .libs/ndarray_ops.o
	...
	$(NVCC)  -shared .libs/numpower.o .libs/initializers.o .libs/double_math.o .libs/ndarray.o .libs/debug.o .libs/buffer.o .libs/logic.o .libs/gpu_alloc.o .libs/linalg.o .libs/manipulation.o .libs/iterators.o .libs/ndarray_ops.o .libs/indexing.o .libs/arithmetics.o .libs/types.o  .libs/cuda_math.o -lcublas -lcusolver -lcudart -llapack -lopenblas -lpthread -lcuda  -o .libs/ndarray.so
