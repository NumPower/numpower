 ...
 */
void*
slice_double(double* buffer, int ndims, int* shape, int* strides, int* start, int* stop, int* step,
             double* out_buffer, int* out_shape, int* out_strides, int* out_ndims)
{
